...
namespace Zust.WebUI.Controllers
{
    ...
    public class MessageController : Controller
    {
        ...
        public MessageController(ILogger<HomeController> logger, UserManager<CustomIdentityUser> userManager, ICustomIdentityUserService customIdentityUserService, IFriendService friendService, IFriendRequestService friendRequestService, IChatService chatService, IMessageService messageService, ZustDbContext context)
        {
            _logger = logger;
